        ...
        if df_customers is not None:
            ...
            with detailPanel:
                ...
                if has_customer_selected:
                    ...
                    st.code(json.dumps(customer_data, indent=4))
                    ...
                    for product in customer_products:
                        ...
                        with col3:
                            ...
                            product['total_value'] = st.number_input(
                                'Total',
                                value = product['quantity'] * currency_to_number(unit_price) if unit_price != 0 else None,
                                disabled = True
                            )
                    st.button('Adicionar', on_click=add_empty_product)
